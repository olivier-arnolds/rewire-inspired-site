            ...
            {[
              ...
              <div key={i} className="h-20 flex items-center justify-center p-4 border border-white/10 rounded-lg bg-white/5 hover:bg-white/10 hover:border-primary/30 transition-all cursor-pointer group">
                <img 
                  src={client.src} 
                  alt={client.name} 
                  className={`max-w-full max-h-full object-contain brightness-0 invert group-hover:brightness-100 group-hover:invert-0 transition-all duration-300 ${client.className || ''}`}
                />
              </div>
            ))}
          </div>
